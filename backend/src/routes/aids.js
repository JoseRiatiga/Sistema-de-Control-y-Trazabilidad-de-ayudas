...
router.post('/types', verifyRole(['admin']), AidTypeController.create);
router.get('/types', AidTypeController.getAll);

// Rutas para entregas (operadores y admins)
router.post('/delivery', verifyRole(['admin', 'operador']), checkDuplicateDelivery, AidDeliveryController.create);
